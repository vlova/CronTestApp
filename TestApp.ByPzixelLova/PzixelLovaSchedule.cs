...
{
    public class PzixelLovaSchedule
    {
        ...
        /// </param>
        public PzixelLovaSchedule(string scheduleString)
        {
        ...
        private DateTime Closest<TIsIncrementing>(DateTime t1) where TIsIncrementing : struct, IBool
        {
            ...
            LoopStart:;
                ...
                {
                    t1 = yearChanger.Change<TIsIncrementing>(t1, _innerSchedule.Years);
                }
                ...
                {
                    t1 = monthChanger.Change<TIsIncrementing>(t1, _innerSchedule.Months);
                    if (t1.Year != year)
                    {
                        goto LoopStart;
                    }
                             ...
                             && t1.Day == DateTime.DaysInMonth(t1.Year, t1.Month))))
                {
                    ...
                    t1 = dayChanger.Change<TIsIncrementing>(t1, _innerSchedule.Days);
                    if (t1.Month != month)
                    {
                        goto LoopStart;
                    }
                ...
                {
                    t1 = hourChanger.Change<TIsIncrementing>(t1, _innerSchedule.Hours);
                    if (t1.Day != day)
                    {
                        goto LoopStart;
                    }
                ...
                {
                    t1 = minuteChanger.Change<TIsIncrementing>(t1, _innerSchedule.Minutes);
                    if (t1.Hour != hour)
                    {
                        goto LoopStart;
                    }
                ...
                {
                    t1 = secondChanger.Change<TIsIncrementing>(t1, _innerSchedule.Seconds);
                    if (t1.Minute != minute)
                    {
                        goto LoopStart;
                    }
                ...
                {
                    t1 = millisecondChanger.Change<TIsIncrementing>(t1, _innerSchedule.Milliseconds);
                    if (t1.Second != second)
                    {
                        goto LoopStart;
                    }
